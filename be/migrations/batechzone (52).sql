...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2026 at 08:24 AM
...
(184, 21, 42, 1, 8800000.00, '2026-01-17 15:54:16', '2026-01-17 15:54:16'),
...
(6, 'admin', 'admin@gmail.com', '$2b$10$84e9xqnTc50CPaf5pOldT.Ob9zW9/RVK.G3Whr.TdAncfRdE.UivG', 'admin', '0123456788', 2, 1, '2025-11-05 09:33:52', '2026-01-19 06:58:05', NULL, NULL, NULL, NULL, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjYsInVzZXJuYW1lIjoiYWRtaW4iLCJlbWFpbCI6ImFkbWluQGdtYWlsLmNvbSIsInJvbGUiOjIsInNlc3Npb25UeXBlIjoiYWRtaW4iLCJpYXQiOjE3Njg4MDU4ODUsImV4cCI6MTc2OTQxMDY4NX0.YBuxCWOeT4D1Bzxwe8gtSxsBlEAClKG9poZ4jacfRcI', NULL),
...
--
ALTER TABLE `bundle_items`
  MODIFY `bundle_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
...
--
ALTER TABLE `cart_items`
  MODIFY `cart_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
...
--
ALTER TABLE `variant_serials`
  MODIFY `serial_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
