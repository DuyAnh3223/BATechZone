...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 15, 2025 lúc 06:23 AM
...
(1, 'Hãng', 'other', 1, 1, NOW()),
(2, 'Socket', 'other', 2, 1, NOW()),
(3, 'Dòng sản phẩm', 'other', 3, 1, NOW()),
(4, 'Loại sản phẩm', 'other', 4, 1, NOW()),
(5, 'Hãng', 'other', 1, 1, NOW()),
(6, 'Dòng card', 'other', 2, 1, NOW()),
(7, 'Bộ nhớ', 'storage', 3, 1, NOW()),
(8, 'Nhà sản xuất', 'other', 4, 1, NOW()),
(9, 'Hãng', 'other', 1, 1, NOW()),
(10, 'Loại RAM', 'ram', 2, 1, NOW()),
(11, 'Dung lượng', 'ram', 3, 1, NOW()),
(12, 'Tốc độ', 'other', 4, 1, NOW()),
(13, 'Màu sắc', 'color', 5, 1, NOW()),
(14, 'Hãng', 'other', 1, 1, NOW()),
(15, 'Loại SSD', 'storage', 2, 1, NOW()),
(16, 'Dung lượng', 'storage', 3, 1, NOW()),
(17, 'Hãng', 'other', 1, 1, NOW()),
(18, 'Socket', 'other', 2, 1, NOW()),
(19, 'Form Factor', 'size', 3, 1, NOW()),
(20, 'WiFi', 'other', 4, 1, NOW()),
(21, 'Hãng', 'other', 1, 1, NOW()),
(22, 'Công suất', 'other', 2, 1, NOW()),
(23, 'Chứng nhận 80 Plus', 'other', 3, 1, NOW()),
(24, 'Hãng', 'other', 1, 1, NOW()),
(25, 'Form Factor', 'size', 2, 1, NOW()),
(26, 'Màu sắc', 'color', 3, 1, NOW()),
(27, 'RGB', 'other', 4, 1, NOW()),
(28, 'Hãng', 'other', 1, 1, NOW()),
(29, 'Loại tản nhiệt', 'other', 2, 1, NOW()),
(30, 'Kích thước', 'size', 3, 1, NOW()),
(31, 'RGB', 'other', 4, 1, NOW()),
(32, 'Hãng', 'other', 1, 1, NOW()),
(33, 'Dung lượng', 'storage', 2, 1, NOW()),
(34, 'Tốc độ quay', 'other', 3, 1, NOW());
...
(1, 1, 'Intel', NULL, NULL, 1, 1, NOW()),
(2, 1, 'AMD', NULL, NULL, 2, 1, NOW()),
(3, 2, 'LGA1700', NULL, NULL, 1, 1, NOW()),
(4, 2, 'AM5', NULL, NULL, 2, 1, NOW()),
(5, 2, 'AM4', NULL, NULL, 3, 1, NOW()),
(6, 3, 'Core i5', NULL, NULL, 1, 1, NOW()),
(7, 3, 'Core i7', NULL, NULL, 2, 1, NOW()),
(8, 3, 'Core i9', NULL, NULL, 3, 1, NOW()),
(9, 3, 'Ryzen 5', NULL, NULL, 4, 1, NOW()),
(10, 3, 'Ryzen 7', NULL, NULL, 5, 1, NOW()),
(11, 3, 'Ryzen 9', NULL, NULL, 6, 1, NOW()),
(12, 4, 'Boxed (Có tản nhiệt)', NULL, NULL, 1, 1, NOW()),
(13, 4, 'Tray (Không tản nhiệt)', NULL, NULL, 2, 1, NOW()),
(14, 5, 'NVIDIA', NULL, NULL, 1, 1, NOW()),
(15, 5, 'AMD', NULL, NULL, 2, 1, NOW()),
(16, 6, 'RTX 4060', NULL, NULL, 1, 1, NOW()),
(17, 6, 'RTX 4070', NULL, NULL, 2, 1, NOW()),
(18, 6, 'RTX 4080', NULL, NULL, 3, 1, NOW()),
(19, 6, 'RX 7600', NULL, NULL, 4, 1, NOW()),
(20, 6, 'RX 7800 XT', NULL, NULL, 5, 1, NOW()),
(21, 7, '8GB', NULL, NULL, 1, 1, NOW()),
(22, 7, '12GB', NULL, NULL, 2, 1, NOW()),
(23, 7, '16GB', NULL, NULL, 3, 1, NOW()),
(24, 8, 'ASUS', NULL, NULL, 1, 1, NOW()),
(25, 8, 'MSI', NULL, NULL, 2, 1, NOW()),
(26, 8, 'Gigabyte', NULL, NULL, 3, 1, NOW()),
(27, 8, 'Sapphire', NULL, NULL, 4, 1, NOW()),
(28, 8, 'XFX', NULL, NULL, 5, 1, NOW()),
(29, 8, 'ASRock', NULL, NULL, 6, 1, NOW()),
(30, 8, 'PowerColor', NULL, NULL, 7, 1, NOW()),
(31, 9, 'Corsair', NULL, NULL, 1, 1, NOW()),
(32, 9, 'G.Skill', NULL, NULL, 2, 1, NOW()),
(33, 9, 'Kingston', NULL, NULL, 3, 1, NOW()),
(34, 9, 'Team Group', NULL, NULL, 4, 1, NOW()),
(35, 9, 'ADATA', NULL, NULL, 5, 1, NOW()),
(36, 10, 'DDR4', NULL, NULL, 1, 1, NOW()),
(37, 10, 'DDR5', NULL, NULL, 2, 1, NOW()),
(38, 11, '16GB (2x8GB)', NULL, NULL, 1, 1, NOW()),
(39, 11, '32GB (2x16GB)', NULL, NULL, 2, 1, NOW()),
(40, 11, '64GB (2x32GB)', NULL, NULL, 3, 1, NOW()),
(41, 12, '3200MHz', NULL, NULL, 1, 1, NOW()),
(42, 12, '3600MHz', NULL, NULL, 2, 1, NOW()),
(43, 12, '5600MHz', NULL, NULL, 3, 1, NOW()),
(44, 12, '6000MHz', NULL, NULL, 4, 1, NOW()),
(45, 12, '6400MHz', NULL, NULL, 5, 1, NOW()),
(46, 13, 'Đen', '#000000', NULL, 1, 1, NOW()),
(47, 13, 'Trắng', '#FFFFFF', NULL, 2, 1, NOW()),
(48, 13, 'Bạc', '#C0C0C0', NULL, 3, 1, NOW()),
(49, 14, 'Samsung', NULL, NULL, 1, 1, NOW()),
(50, 14, 'WD', NULL, NULL, 2, 1, NOW()),
(51, 14, 'Crucial', NULL, NULL, 3, 1, NOW()),
(52, 14, 'Kingston', NULL, NULL, 4, 1, NOW()),
(53, 14, 'Seagate', NULL, NULL, 5, 1, NOW()),
(54, 15, 'NVMe M.2', NULL, NULL, 1, 1, NOW()),
(55, 15, 'SATA M.2', NULL, NULL, 2, 1, NOW()),
(56, 15, 'SATA 2.5"', NULL, NULL, 3, 1, NOW()),
(57, 16, '256GB', NULL, NULL, 1, 1, NOW()),
(58, 16, '512GB', NULL, NULL, 2, 1, NOW()),
(59, 16, '1TB', NULL, NULL, 3, 1, NOW()),
(60, 16, '2TB', NULL, NULL, 4, 1, NOW()),
(61, 16, '4TB', NULL, NULL, 5, 1, NOW()),
(62, 17, 'ASUS', NULL, NULL, 1, 1, NOW()),
(63, 17, 'MSI', NULL, NULL, 2, 1, NOW()),
(64, 17, 'Gigabyte', NULL, NULL, 3, 1, NOW()),
(65, 17, 'ASRock', NULL, NULL, 4, 1, NOW()),
(66, 18, 'LGA1700', NULL, NULL, 1, 1, NOW()),
(67, 18, 'AM5', NULL, NULL, 2, 1, NOW()),
(68, 18, 'AM4', NULL, NULL, 3, 1, NOW()),
(69, 19, 'ATX', NULL, NULL, 1, 1, NOW()),
(70, 19, 'mATX', NULL, NULL, 2, 1, NOW()),
(71, 19, 'ITX', NULL, NULL, 3, 1, NOW()),
(72, 20, 'WiFi 6', NULL, NULL, 1, 1, NOW()),
(73, 20, 'WiFi 6E', NULL, NULL, 2, 1, NOW()),
(74, 20, 'Không có WiFi', NULL, NULL, 3, 1, NOW()),
(75, 21, 'Corsair', NULL, NULL, 1, 1, NOW()),
(76, 21, 'Seasonic', NULL, NULL, 2, 1, NOW()),
(77, 21, 'Cooler Master', NULL, NULL, 3, 1, NOW()),
(78, 21, 'Thermaltake', NULL, NULL, 4, 1, NOW()),
(79, 21, 'EVGA', NULL, NULL, 5, 1, NOW()),
(80, 22, '550W', NULL, NULL, 1, 1, NOW()),
(81, 22, '650W', NULL, NULL, 2, 1, NOW()),
(82, 22, '750W', NULL, NULL, 3, 1, NOW()),
(83, 22, '850W', NULL, NULL, 4, 1, NOW()),
(84, 22, '1000W', NULL, NULL, 5, 1, NOW()),
(85, 23, '80 Plus Bronze', NULL, NULL, 1, 1, NOW()),
(86, 23, '80 Plus Gold', NULL, NULL, 2, 1, NOW()),
(87, 23, '80 Plus Platinum', NULL, NULL, 3, 1, NOW()),
(88, 23, '80 Plus Titanium', NULL, NULL, 4, 1, NOW()),
(89, 24, 'Corsair', NULL, NULL, 1, 1, NOW()),
(90, 24, 'Fractal Design', NULL, NULL, 2, 1, NOW()),
(91, 24, 'NZXT', NULL, NULL, 3, 1, NOW()),
(92, 24, 'Cooler Master', NULL, NULL, 4, 1, NOW()),
(93, 24, 'Phanteks', NULL, NULL, 5, 1, NOW()),
(94, 25, 'ATX', NULL, NULL, 1, 1, NOW()),
(95, 25, 'mATX', NULL, NULL, 2, 1, NOW()),
(96, 25, 'ITX', NULL, NULL, 3, 1, NOW()),
(97, 26, 'Đen', '#000000', NULL, 1, 1, NOW()),
(98, 26, 'Trắng', '#FFFFFF', NULL, 2, 1, NOW()),
(99, 27, 'Có RGB', NULL, NULL, 1, 1, NOW()),
(100, 27, 'Không có RGB', NULL, NULL, 2, 1, NOW()),
(101, 28, 'Corsair', NULL, NULL, 1, 1, NOW()),
(102, 28, 'Noctua', NULL, NULL, 2, 1, NOW()),
(103, 28, 'Deepcool', NULL, NULL, 3, 1, NOW()),
(104, 28, 'Arctic', NULL, NULL, 4, 1, NOW()),
(105, 28, 'Cooler Master', NULL, NULL, 5, 1, NOW()),
(106, 29, 'AIO (Tản nhiệt nước)', NULL, NULL, 1, 1, NOW()),
(107, 29, 'Air (Tản nhiệt khí)', NULL, NULL, 2, 1, NOW()),
(108, 30, '120mm', NULL, NULL, 1, 1, NOW()),
(109, 30, '240mm', NULL, NULL, 2, 1, NOW()),
(110, 30, '360mm', NULL, NULL, 3, 1, NOW()),
(111, 30, 'Single Tower', NULL, NULL, 4, 1, NOW()),
(112, 30, 'Dual Tower', NULL, NULL, 5, 1, NOW()),
(113, 31, 'Có RGB', NULL, NULL, 1, 1, NOW()),
(114, 31, 'Không có RGB', NULL, NULL, 2, 1, NOW()),
(115, 32, 'Seagate', NULL, NULL, 1, 1, NOW()),
(116, 32, 'Western Digital', NULL, NULL, 2, 1, NOW()),
(117, 32, 'Toshiba', NULL, NULL, 3, 1, NOW()),
(118, 33, '1TB', NULL, NULL, 1, 1, NOW()),
(119, 33, '2TB', NULL, NULL, 2, 1, NOW()),
(120, 33, '3TB', NULL, NULL, 3, 1, NOW()),
(121, 33, '4TB', NULL, NULL, 4, 1, NOW()),
(122, 33, '8TB', NULL, NULL, 5, 1, NOW()),
(123, 34, '5400RPM', NULL, NULL, 1, 1, NOW()),
(124, 34, '7200RPM', NULL, NULL, 2, 1, NOW());
...
(181, 1, 'Intel Core i7-14700K', 'intel-core-i7-14700k', 'CPU Intel Core i7 thế hệ 14, 20 nhân (8P + 12E), 28 luồng, Base 3.4GHz, Boost 5.6GHz, Socket LGA1700, Có GPU tích hợp Intel UHD Graphics 770', 8500000.00, 1, 1, 10, 0.00, 0, '2025-11-15 03:55:48', '2025-11-15 04:50:58', '/uploads/products/cpu/intel-i7-14700k.jpg'),
...
(230, 1, 'Intel Core i5-14600KF', 'intel-core-i5-14600kf', 'CPU Intel Core i5 thế hệ 14, 14 nhân (6P + 8E), 20 luồng, Base 3.5GHz, Boost 5.3GHz, Socket LGA1700, Không có GPU tích hợp', 4500000.00, 1, 1, 26, 0.00, 0, '2025-11-15 04:08:05', '2025-11-15 05:22:28', '/uploads/products/cpu/intel-i5-14600kf.jpg');
...
--
ALTER TABLE `product_variants`
  MODIFY `variant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=326;
