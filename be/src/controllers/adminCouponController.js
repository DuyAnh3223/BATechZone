...
export const createCoupon = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'Lỗi tạo coupon', error: e.message });
    }
};
...
export const getCouponById = async (req, res) => {
    try {
        ...
        console.error('Error getting coupon:', e);
...
export const updateCoupon = async (req, res) => {
    try {
        ...
        return res.status(500).json({ success: false, message: 'Lỗi cập nhật coupon', error: e.message });
    }
};
