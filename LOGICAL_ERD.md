...
erDiagram
    ...
    ATTRIBUTES ||--o{ ATTRIBUTE_CATEGORIES : "linked to"
    ...
    PRODUCT_VARIANTS ||--o{ BUILD_ITEMS : "in build"

    CARTS ||--o{ CART_ITEMS : "contains"

    ORDERS ||--o{ ORDER_ITEMS : "contains"
    ORDERS ||--o{ PAYMENTS : "has"
    ORDERS ||--o{ INSTALLMENTS : "paid via"
    ...
    VARIANT_SERIALS ||--o{ WARRANTIES : "covered by"
    VARIANT_SERIALS ||--o{ SERVICE_REQUESTS : "serviced"

    WARRANTIES ||--o{ SERVICE_REQUESTS : "under warranty"

    BUILDS ||--o{ BUILD_ITEMS : "consists of"

    ARTICLES ||--o{ POSTS : "categorized in"
