  ...
  return (
    <div className="space-y-1.5 text-xs">
      <div className="flex items-center gap-2">
        <span className="text-gray-500 min-w-[100px]">Mã sản phẩm:</span>
        <span className="font-medium">#{product.product_id}</span>
      </div>
      {product.slug && (
        <div className="flex items-center gap-2">
          <span className="text-gray-500 min-w-[100px]">Slug:</span>
          <span className="font-medium">{product.slug}</span>
        </div>
      )}
      <div className="flex items-center gap-2">
        <span className="text-gray-500 min-w-[100px]">Lượt xem:</span>
